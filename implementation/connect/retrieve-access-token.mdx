...
<Check>After completing this step, your application will be able to exchange authorization codes 
for access tokens securely and automatically. You are ready to use the access token to make API requests
to Chart's various endpoints.</Check>