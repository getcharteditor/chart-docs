...
Select the SDK that best suits your application's technology stack. Otherwise, you can use the Redirect flow.
    ...
    either by adding a script tag to your HTML file or by importing it as a module.
        ...
        - `<script src="https://cdn.trychartapi.com/script.js"></script>`
...
You can find this `client_id` in your [Chart Developer Dashboard](https://dashboard.trychartapi.com).
...
hosted by Chart on `https://connect.trychartapi.com`. After a successful connection, 
...
The `redirect_uri` must be set in the [Chart Developer Dashboard](https://dashboard.trychartapi.com). Otherwise, the request will fail.
...
<Check>After completing this step, you will have successfully integrated Chart Connect into your application's frontend.
This will enable users to authenticate with their tax systems, providing your application with the necessary authorization 
to [obtain an access token](/implementation//connect/retrieve-access-token) in the next step.</Check>
