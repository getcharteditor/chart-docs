...
<Note>**Ready to get started? [Create An Account](/implementation/connect/set-up-chart-connect)**</Note>
...
In this case, Chart Connect is securely hosted by Chart on `https://connect.trychartapi.com` instead of your application. 
