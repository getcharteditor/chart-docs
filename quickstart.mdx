...
To get started, sign up for a free account [here](https://dashboard.trychartapi.com/auth/signup). 
...
In your [Chart Dashboard](https://dashboard.trychartapi.com/auth/signup), go to the “Redirect URIs” 
...
in your [Chart Dashboard](https://dashboard.trychartapi.com/auth/signup). 
